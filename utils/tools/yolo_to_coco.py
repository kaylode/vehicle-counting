...
idx_classes = ['motorcycle', 'car', 'bus', 'truck']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ann_path', type=str, help='path to yolo format folder')
    parser.add_argument('--img_path', type=str, help='path to image folder')
    parser.add_argument('--out_path', type=str, default='./annotations.json', help='path to output json file')
